...
/datum/equipment_preset/ms/hg/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/satchel/sec
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/security
...
/datum/equipment_preset/ms/quartermaster
...
/datum/equipment_preset/ms/quartermaster/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/ms/cargo
...
/datum/equipment_preset/ms/cargo/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel/tech
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/industrial
...
/datum/equipment_preset/ms/bcm/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel/tech
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
...
/datum/equipment_preset/ms/bc/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel/tech
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine/tech
...
/datum/equipment_preset/ms/reporter
...
/datum/equipment_preset/ms/reporter/New()
	. = ..()
	access = get_access(ACCESS_LIST_MARINE_LIAISON) + list(ACCESS_PRESS)

/datum/equipment_preset/ms/reporter/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/satchel
